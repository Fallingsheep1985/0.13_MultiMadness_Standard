...
DZAI_heliList = [["UH1H_DZ",2],["CH53_DZE",2],["MV22_DZ",2],["UH1Y_DZE",2],["MH6J_DZ",2]];
...
DZAI_vehList = [["UAZ_Unarmed_TK_EP1",2],["HMMWV_M1035_DES_EP1",2],["ArmoredSUV_PMC_DZE",1],["LandRover_CZ_EP1",2],["Offroad_DSHKM_Gue_DZE",3]];
